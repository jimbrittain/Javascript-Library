"use strict";
/* jshint  -W083 */
/* global $, document, fetter, __imns, window */
/* notes. Need to replace WhenWindowLoads with fetter*/
var adr = __imns('component.classes');
// var adr = window; //for stand-alone delete above and uncomment this line
if(!('FirstWordPseudo' in adr)){


    adr.FirstWordPseudo = function(selector_name, replacement_classname){
        this.parse_arr = [];
        this.selectors = [];
        this.rules = [];
        this.sel = "";
        ...
        (__imns('util.tools')).fetter(window, 'load', [c, function(){ c.init(selector_name, replacement_classname); }], true, 'both');
    };
    adr.FirstWordPseudo.prototype.init = function(selector_name, replacement_classname){
    ...
    adr.FirstWordPseudo.prototype.cycle = function(){
        var s = '', h = '', c = this;
    ...
    adr.FirstWordPseudo.prototype.create = function(){
        ...
        this.createSpans(); };
    adr.FirstWordPseudo.prototype.parseCSS = function(str){
    ...
    adr.FirstWordPseudo.prototype.createSpans = function(){
        var c = this;
