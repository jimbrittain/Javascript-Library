...
if(!('Alignment' in adr)){
    ...
    **/
    ...
    adr.Alignment.prototype.determineValue = function(n){
    ...
    adr.Alignment.prototype.verticalValue = function(){
    ...
    adr.Alignment.prototype.horizontalValue = function(){
    ...
    adr.Alignment.prototype.registrationValue = function(){
    ...
    adr.Alignment.prototype.registrationXValue = function(){
        if(this.registration === 'fixed'){
            ...
            switch(this.registration) {
                ...
                default: //middle;
                    return 0.5; }}};
    adr.Alignment.prototype.registrationYValue = function(){
        if(this.registration === 'fixed'){
