...
if(!('MinMaxController' in adr)){
    adr.MinMaxController = function(o){
        this.max = 0;
        this.min = 0;
        this.step = 1;
        this.min_element = "";
    ...
    adr.MinMaxController.prototype.setMinimumElement = function(e){
        var uv = __imns('util.validation');
        if(e !== undefined && uv.isHTMLElement(e)){
            this.min_element = e;
            if(!this.beenSet){ this.setMinMax(this.min_element); }}};
    adr.MinMaxController.prototype.setMaximumElement = function(e){
        var uv = __imns('util.validation');
        if(e !== undefined && uv.isHTMLElement(e)){
            this.max_element = e;
            if(!this.beenSet){ this.setMinMax(this.max_element); }}};
    adr.MinMaxController.prototype.setMinMax = function(o){
        var uv = __imns('util.validation');
        if(!this.beenSet){
            var elem = "";
            var min = -1;
            ...
            var round = 0;
            if(typeof o === "object"){
                elem = ('element' in o && o.element !== undefined && uv.isHTMLElement(o.element)) ? o.element : "";
    ...
    adr.MinMaxController.prototype.init = function(a){
        if(typeof a === 'object'){
    ...
    adr.MinMaxController.prototype.calc = function(){
        if(this.beenSet){
    ...
    adr.MinMaxController.prototype.valueChange = function(val, dflt){
        if(isNaN(Number(val))){
            val = dflt;
        } else {
            val = Number(val);
            ...
            val = (this.rounding > 0) ? val / (this.rounding * 10) : val; }
        return Number(val); }; 
    adr.MinMaxController.prototype.change = function(elem){
        var testNumber = 0;
