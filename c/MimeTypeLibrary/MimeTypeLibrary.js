...
/* global navigator, window, window.vbsActive, vbsPluginCheck, ActiveXReference, MimeTypeReference, */
		function MimeTypeReference(_t, _h, _e){
			this._type =_t;
            this._ext = _e;
			this._handlers = [];
...
MimeTypeLibrary.prototype.addMimeReference = function(_t, _h, _e){
    var lastArg = arguments.length - 1;
    if(arguments[lastArg] === undefined || arguments[lastArg] !== "closekill"){ this.addCOMReference(_h, _t, "closekill"); }
...
MimeTypeLibrary.prototype.addCOMReference = function(_h, _t){
    var lastArg = arguments.length - 1;
    if(arguments[lastArg] === undefined || arguments[lastArg] !== "closekill"){ this.addMimeReference(_t, _h, "closekill"); }
...
MimeTypeLibrary.prototype.determineMimeTypeFromFileName = function(filename){
    if(typeof filename === 'string'){
        var extMatch = /.([A-Za-z0-9]{2,3})$/;
        if(extMatch.test(filename)){
            return filename.match(extMatch)[1];
        }
    }
    return ''; };

var mimeLib = new MimeTypeLibrary();
mimeLib.addMimeReference('application/x-shockwave-flash', 'ShockwaveFlash.ShockwaveFlash', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'ShockwaveFlash.ShockwaveFlash.2', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'ShockwaveFlash.ShockwaveFlash.3', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'ShockwaveFlash.ShockwaveFlash.4', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'ShockwaveFlash.ShockwaveFlash.5', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'ShockwaveFlash.ShockwaveFlash.6', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'ShockwaveFlash.ShockwaveFlash.7', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'ShockwaveFlash.ShockwaveFlash.8', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'ShockwaveFlash.ShockwaveFlash.9', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'ShockwaveFlash.ShockwaveFlash.10', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'Flash10e.ocx', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'Flash9.ocx', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'Flash8.ocx', 'swf');
mimeLib.addMimeReference('application/x-shockwave-flash', 'Flash.ocx', 'swf');
mimeLib.addMimeReference('application/futuresplash', 'ShockwaveFlash.ShockwaveFlash', 'swf');
mimeLib.addMimeReference('application/pdf', 'PDF.PdfCtrl.1', 'pdf');
mimeLib.addMimeReference('application/pdf', 'AcroExch.Document', 'pdf');
mimeLib.addMimeReference('application/pdf', 'AcroIEHelper.ocx', 'pdf');
...
mimeLib.addMimeReference('application/mp4', 'QuickTimeCheckObject.QuickTimeCheck.1', 'mp4');
mimeLib.addMimeReference('application/mp4', 'QuickTime.QuickTime.4', 'mp4');
mimeLib.addMimeReference('application/mp4', 'QuickTime.QuickTime', 'mp4');
...
mimeLib.addMimeReference('video/ogv', '', 'ogv');
...
mimeLib.addMimeReference('audio/mp3', 'MediaPlayer.MediaPlayer.1', 'mp3');
mimeLib.addMimeReference('audio/mp3', 'RealPlayer.RealPlayer(tm) ActiveX Control (32-bit)', 'mp3');
mimeLib.addMimeReference('audio/mp3', 'rmocx.RealPlayer G2 Control', 'mp3');
mimeLib.addMimeReference('audio/mp3', 'QuickTimeCheckObject.QuickTimeCheck.1', 'mp3');
mimeLib.addMimeReference('audio/mp3', 'QuickTime.QuickTime.4', 'mp3');
mimeLib.addMimeReference('audio/mp3', 'QuickTime.QuickTime', 'mp3');
mimeLib.addMimeReference('audio/x-wav', 'WMPlayer.OCX', 'wav');
mimeLib.addMimeReference('audio/x-wav', 'MediaPlayer.MediaPlayer.1', 'wav');
mimeLib.addMimeReference('audio/x-wav', 'RealPlayer.RealPlayer(tm) ActiveX Control (32-bit)', 'wav');
mimeLib.addMimeReference('audio/x-wav', 'rmocx.RealPlayer G2 Control', 'wav');
mimeLib.addMimeReference('audio/mp4', 'QuickTimeCheckObject.QuickTimeCheck.1', 'mp4');
mimeLib.addMimeReference('audio/mp4', 'QuickTime.QuickTime.4', 'mp4');
mimeLib.addMimeReference('audio/mp4', 'QuickTime.QuickTime', 'mp4');
mimeLib.addMimeReference('audio/ogg', '', 'ogg');
mimeLib.addMimeReference('audio/opus', '', 'opus');
mimeLib.addMimeReference('audio/oga', '', 'oga');
