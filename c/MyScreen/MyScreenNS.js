"use strict";
/* global __imns, window, document, screen */
var adr = __imns('util.classes');
// var adr = window; //for stand-alone delete above and uncomment this line
if(!('MyScreen' in adr)){
    adr.MyScreen = function(){
        var uc = __imns('util.classes');
        if(uc.MyScreen.prototype.singleton !== undefined){ return uc.MyScreen.prototype.singleton; }
        uc.MyScreen.prototype.singleton = this;
        this.bounds = {};
        this.offset = {};
        this.screen = {
    ...
    adr.MyScreen.prototype.screenOffsetX = function(){
        if(arguments.length === 1 && typeof arguments[0] === 'number'){
            ...
            return undefined; }};
    adr.MyScreen.prototype.screenOffsetY = function(){
        if(arguments.length === 1 && typeof arguments[0] === 'number'){
            ...
            return undefined; }};
    // :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    adr.MyScreen.prototype.getPageBounds = function(){
        this.bounds = {};
        this.bounds = {
    ...
    adr.MyScreen.prototype.getPageOffset = function(){
        this.offset = {
            'x' : this.pageOffsetX(), 
            'y' : this.pageOffsetY()};
        return this.offset; };
    adr.MyScreen.prototype.documentWidth = function(){
        var ud = __imns('util.dom');
        var temp = "";
        var bodyArr = ud.findElementsByTag('html');
        if(bodyArr.length === 1){
            temp = ud.findElementStyle(bodyArr[0], 'width');
    ...
    adr.MyScreen.prototype.documentHeight = function(){
        var ud = __imns('util.dom');
        var temp = "";
        var bodyArr = ud.findElementsByTag('html');
        if(bodyArr.length === 1){
            temp = ud.findElementStyle(bodyArr[0], 'height');
            return parseInt(temp); }
        if('clientHeight' in document.body){
            return document.body.clientHeight;
        } else if(document.documentElement && 'clientHeight' in document.documentElement){ 
            return document.documentElement.clientHeight; }};
    adr.MyScreen.prototype.innerWindowWidth = function(){
        if('innerWidth' in window){
            ...
            return document.body.clientWidth; }};
    adr.MyScreen.prototype.innerWindowHeight = function(){
        if('innerHeight' in window){
            ...
            return document.body.clientHeight; }};
    adr.MyScreen.prototype.scrollTo = function(x, y){
        if(window.scrollTo){
            window.scrollTo(x, y);
