...
if(!('CubicBezierCoordinates' in adr)){
    /*
    ...
    adr.CubicBezierCoordinates = function(){
        this.p0 = null;
        this.p1 = null;
     ...
     * @return {Boolean} True
     */
    adr.CubicBezierCoordinates.prototype.reset = function(){
        this.arcs_ys = [];
        this.arcs_xs = [];
        this.arc_lengths = [];
        this.length = null;
     ...
     * @return {}
     */
    adr.CubicBezierCoordinates.prototype.determine_arc_ys = function(){
        this.arc_ys = [];
        this.arc_ys[0] = 0;
     ...
     * @return {}
     */
    adr.CubicBezierCoordinates.prototype.determine_arc_xs = function(){
        this.arc_xs = [];
        this.arc_xs[0] = 0;
        for(var i=1, max = this.len; i < max; i += 1){
     ...
     * @return {}
     */
    adr.CubicBezierCoordinates.prototype.determine_lengths = function(){
     ...
     * @return {Boolean}
     */
    adr.CubicBezierCoordinates.prototype.cssSet = function(){
        var uc = __imns('util.classes');
        this.setPoint0(0,0);
        this.setPoint1(1,1);
        var a = (arguments.length === 1 && typeof arguments[0] === 'string') ? this.stringStrip(arguments[0]) : this.arguments;
        if(a.length === 2 && a[0] instanceof uc.Coordinates && a[1] instanceof uc.Coordinates){
     ...
     * @return {}
     */
    adr.CubicBezierCoordinates.prototype.setPoint0 = function(){ 
        var uc = __imns('util.classes');
        this.p0 = (arguments[0] !== undefined && arguments[0] instanceof uc.Coordinates) ? arguments[0] : (new uc.Coordinates(arguments[0], (arguments[1] !== undefined) ? arguments[1]: undefined)); 
     ...
     * @needs CubicBezierCoordinates.reset
     */
    adr.CubicBezierCoordinates.prototype.setPoint1 = function(){ 
        var uc = __imns('util.classes');
        this.p1 = (arguments[0] !== undefined && arguments[0] instanceof uc.Coordinates) ? arguments[0] : (new uc.Coordinates(arguments[0], (arguments[1] !== undefined) ? arguments[1]: undefined));
        if(this.initialised){ this.reset(); }};
    /**
     ...
     * @return {}
     */
    adr.CubicBezierCoordinates.prototype.setControlPoint0 = function(){
        var uc = __imns('util.classes');
        this.cp0 = (arguments[0] !== undefined && arguments[0] instanceof uc.Coordinates) ? arguments[0] : (new uc.Coordinates(arguments[0], (arguments[1] !== undefined) ? arguments[1]: undefined));
        if(this.initialised){ this.reset(); }};
    /**
     ...
     * @return {}
     */
    adr.CubicBezierCoordinates.prototype.setControlPoint1 = function(){ 
        var uc = __imns('util.classes');
        this.cp1 = (arguments[0] !== undefined && arguments[0] instanceof uc.Coordinates) ? arguments[0] : (new uc.Coordinates(arguments[0], (arguments[1] !== undefined) ? arguments[1]: undefined));
        if(this.initialised){ this.reset(); }};
    /**
     ...
     */
    adr.CubicBezierCoordinates.prototype.stringStrip = function(s){
        var uc = __imns('util.classes'),
        ...
        if(typeof s === 'string'){
            ...
            var a = s.split(',');
            if(a.length === 4){
                for(var i=0, max = a.length; i < max; i += 1){ a[i] = (uv.isNumber(a[i])) ? a[i] : 0; }
                return [new uc.Coordinates(a[0], a[1]), new uc.Coordinates(a[2], a[3])];
            } else { return []; }
        } else { return []; }};
    /**
     ...
     * @return {}
     */
    adr.CubicBezierCoordinates.prototype.map = function(t){
    ...
    adr.CubicBezierCoordinates.prototype.map_lengthsX = function(t){ return this.calculateXPosition(this.map(t)); };
    adr.CubicBezierCoordinates.prototype.map_lengthsY = function(t){ return this.calculateYPosition(this.map(t)); };

    adr.CubicBezierCoordinates.prototype.map_arcs = function(n, xory){
        var i = 0, imax = 0;
    ...
    adr.CubicBezierCoordinates.prototype.map_arcsY = function(x){ return this.map_arcs(x, true); };
    adr.CubicBezierCoordinates.prototype.map_arcsX = function(y){ return this.map_arcs(y, true); };
    adr.CubicBezierCoordinates.prototype.findYPositionFromX = function(x){ return this.calculateYPosition(this.map_arcsX(x)); };
    adr.CubicBezierCoordinates.prototype.findXPositionFromY = function(y){ return this.calculateXPosition(this.map_arcsY(y)); };
    adr.CubicBezierCoordinates.prototype.calculateXPosition = function(t){
        ...
        return ((1 - t) * d) + (t * e); };
    adr.CubicBezierCoordinates.prototype.calculateYPosition = function(t){
    ...
    adr.CubicBezierCoordinates.prototype.calculatePositionFromT = function(t){
        var uc = __imns('util.classes');
        return new uc.Coordinates(
