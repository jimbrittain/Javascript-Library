"use strict";
/* global window, __imns, document, setInterval */
var adr = __imns('util.classes');
// var adr = window; //for stand-alone delete above and uncomment this line
if(!('ResizeOutOfFocus' in adr)){
    ...
    adr.ResizeOutOfFocus = function(){
        var uc = __imns('util.classes');
        if(uc.ResizeOutOfFocus.prototype.singleton){ return uc.ResizeOutOfFocus.prototype.singleton; }
        uc.ResizeOutOfFocus.prototype.singleton = this;
        this.beenDone = false;
        this.often = 2000;
        this.width = 0;
        this.height = 0;
        this._int = null;
        this.init(); };
    adr.ResizeOutOfFocus.prototype.init = function(){
    ...
    adr.ResizeOutOfFocus.prototype.getWidth = function(){
    ...
    adr.ResizeOutOfFocus.prototype.getHeight = function(){
    ...
    adr.ResizeOutOfFocus.prototype.check = function(){
        var obj = {};
        if(!this.beenDone){
    ...
    (function(){ 
        var uc = __imns('util.classes');
        var imResizeOutOfFocus = new uc.ResizeOutOfFocus(); })();
