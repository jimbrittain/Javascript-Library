"use strict";
/* global getAttributer, findElementsByTag, window, Image, fetter, console */
function SrcSetter(){
	if(SrcSetter.prototype.singleton !== undefined){ return SrcSetter.prototype.singleton; }
	SrcSetter.prototype.singleton = this;
	this.supportsSrcset = -1;
	this.dppx = -1;
	this.processed = [];
	var c = this;
	fetter(window, 'load', function(){ c.processAll(); }, true, 'both'); }
SrcSetter.prototype.returnPixelRatio = function(){
	if(this.dppx !== -1){
		return this.dppx;
	...
	this.dppx = 1;
	return 1; };
SrcSetter.prototype.isSrcsetSupported = function(){
...
SrcSetter.prototype.getSrcFromSrcSet = function(e){
	var i, imax, imin;
	...
	for(i=d, imax=s.length; i<imax; i+=1){
		if(s[i] !== undefined){ return s[i]; }}
	return ""; };
SrcSetter.prototype.getImageSrcSet = function(e){
	var srcset = [], m;
	var _src = getAttributer(e, 'src');
	var _srcset = getAttributer(e, 'srcset');
